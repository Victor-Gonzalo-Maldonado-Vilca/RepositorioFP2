...
class Ejercicio4{
	public static void main(String[] args){
		...
		for(int k = 0; k < 5; k++){
			System.out.println((k+1)+".- Nombre: "+soldado[k]+" / Nivel de vida: "+
			nivel_vida[k]+"/ Edad: "+edad[k]+" / Genero: "+genero[k]+" / DNI: " +DNI[k]);
		}
	}
}